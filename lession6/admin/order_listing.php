        ...
        <div class="listing-items">
            ...
            <ul>
                <li class="listing-item-heading">
                    <div class="listing-prop-order listing-id">ID</div>
                    <div class="listing-prop-order listing-name-order">Tên người nhận</div>
                    <div class="listing-prop-order listing-address">Địa chỉ</div>
                    <div class="listing-prop-order listing-phone">Điện thoại</div>

                   

                    <div class="listing-prop-order listing-time">Ngày tạo</div>


                
                    <div class="listing-prop-order listing-button">
                        Xóa
                    </div>
                ...
                while ($row = mysqli_fetch_array($orders)) {
                    ...
                    <div class="listing-prop listing-name-order"><?=$row['name']?></div>
